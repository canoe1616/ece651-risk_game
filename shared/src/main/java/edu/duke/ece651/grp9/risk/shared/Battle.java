...
/**
 * This class is to handle all attacks in a battle round. All attacks would be executed
 * after all move actions completed.
 */
public class Battle {
    ...
    /**
     * The method is to add attacks to the battle. If the attack comes from same player and attack to the same destination,
    ...
    /**
     * The method is to play the battles on each territory. On each territory, there might be multiple players attack the same destination.
