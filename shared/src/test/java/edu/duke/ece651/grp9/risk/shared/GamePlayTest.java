...
class GamePlayTest {
  ...
  public void test_validActionSet() {
    ...
    assertEquals(app1.validActionSet(p1, moves, attacks, upgrades, false, false), error1);
    moves.clear();

    moves.add((MoveAction) app1.createAction(map, "red", "A F 5 0", true));
    String error2 = "This action is invalid: Territory does not exist";
    assertEquals(app1.validActionSet(p1, moves, attacks, upgrades, false, false), error2);
    moves.clear();
    ...
    assertEquals(app1.validActionSet(p1, moves, attacks, upgrades, false, false), error3);
    moves.clear();
    ...
    assertEquals(app1.validActionSet(p1, moves, attacks, upgrades, false,false), error4);
    moves.clear();
    attacks.clear();
    ...
    assertEquals(app1.validActionSet(p1, moves, attacks, upgrades, false, false), null);
    ...
    assertEquals("This action is invalid: Your technology level is not yet at level 2.",
        app1.validActionSet(p1, moves, attacks, upgrades,false,false));
    p1.upgradeTechLevel();
    assertEquals(null, app1.validActionSet(p1, moves, attacks, upgrades, false, false));
    ...
    assertEquals(exp, app1.validActionSet(p1, moves, attacks, upgrades, false, false));
  ...
  public void test_validActionSet_withTechLevel() {
    ...
    assertEquals(null, app1.validActionSet(p1, moves, attacks, upgrades, true, false));
    ...
    assertEquals(error, app1.validActionSet(p1, moves, attacks, upgrades, true, false));
  }
  ...
  public void test_validActionSet_withResearch() {
    ...
    assertEquals(err, app1.validActionSet(p1, moves, attacks, upgrades, false, true));

    Action upgrade = new TechAction(p1);
    upgrade.performAction();
    upgrade.performAction();
    assertEquals(null, app1.validActionSet(p1, moves, attacks, upgrades, false, true));
